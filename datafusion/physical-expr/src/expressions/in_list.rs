...
macro_rules! decimal128_collection_contains_check {
...
fn make_list_contains_decimal(
    ...
    decimal128_collection_contains_check!(array, values, negated, contains_null)
}
...
fn make_set_contains_decimal(
    ...
    decimal128_collection_contains_check!(array, native_set, negated, contains_null)
}
